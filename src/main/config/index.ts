...
export const CheckNetTaskList: CheckNetTask[] = [
  { id: 1, title: '检测内网网关', command: 'ping', args: ['内网网关'], isDynamic: true },
  { id: 2, title: '检测校园网网络服务器', command: 'ping', args: ['10.99.99.99'] },
  { id: 3, title: '检测校园网宿舍认证服务器', command: 'ping', args: ['47.98.217.40'] },
  ...
  { id: 10, title: '校园网络认证网路探测', command: 'tracert', args: ['47.98.217.40'] }
]
